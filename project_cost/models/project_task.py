...
class VivalmoProjectTask(models.Model):
    ...
    x_studio_costo_de_materiales = fields.Float(digits=(32,2),string='Costo de materiales')
    x_studio_costo_de_operaciones = fields.Float(digits=(32,2),string='Costo de operaciones')
