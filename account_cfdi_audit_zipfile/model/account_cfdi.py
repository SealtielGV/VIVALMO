...
class AccountCFDI(models.Model):
    ...
    invoice_ids = fields.One2many('account.move', 'cfdi_id', string='Facturas', required=False, readonly=True)
    ...
    subtotal      = fields.Float(string="SubTotal", default=0.0, required=True, digits=(18,2), readonly=True,force_save=True)
    total         = fields.Float(string="Total", default=0.0, required=True, digits=(18,2),readonly=True,force_save=True)
    monto_pago    = fields.Float(string="Monto Pago", default=0.0, required=True, digits=(18,2), readonly=False)
    ...
    x_file =  fields.Binary('Archivo')
    x_f_name = fields.Char('Nombre del archivo')
